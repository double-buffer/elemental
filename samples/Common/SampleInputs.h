...
void SampleRegisterModelViewerInputBindings(SampleInputActionBindingSpan* inputActionBindings, SampleModelViewerInputActions* inputActions)
{
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyA, 0, SampleInputActionBindingType_Value, &inputActions->RotateLeft);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyD, 0, SampleInputActionBindingType_Value, &inputActions->RotateRight);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyW, 0, SampleInputActionBindingType_Value, &inputActions->RotateUp);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyS, 0, SampleInputActionBindingType_Value, &inputActions->RotateDown);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyQ, 0, SampleInputActionBindingType_Value, &inputActions->RotateSideLeft);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyE, 0, SampleInputActionBindingType_Value, &inputActions->RotateSideRight);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyZ, 0, SampleInputActionBindingType_Value, &inputActions->ZoomIn);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyX, 0, SampleInputActionBindingType_Value, &inputActions->ZoomOut);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeySpacebar, 0, SampleInputActionBindingType_Value, &inputActions->TriangleColor);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyF1, 0, SampleInputActionBindingType_ReleasedSwitch, &inputActions->ShowCursor);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_KeyEscape, 0, SampleInputActionBindingType_Released, &inputActions->ExitApp);

    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseLeftButton, 0, SampleInputActionBindingType_Value, &inputActions->Touch);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseLeftButton, 0, SampleInputActionBindingType_DoubleReleasedSwitch, &inputActions->TriangleColor);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseLeftButton, 0, SampleInputActionBindingType_Released, &inputActions->TouchReleased);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseRightButton, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateSide);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseAxisXNegative, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateLeft);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseAxisXPositive, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateRight);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseAxisYNegative, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateUp);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseAxisYPositive, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateDown);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseWheelPositive, 0, SampleInputActionBindingType_Value, &inputActions->ZoomIn);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseWheelNegative, 0, SampleInputActionBindingType_Value, &inputActions->ZoomOut);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_MouseMiddleButton, 0, SampleInputActionBindingType_Value, &inputActions->TriangleColor);

    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_GamepadLeftStickXNegative, 0, SampleInputActionBindingType_Value, &inputActions->RotateLeft);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_GamepadLeftStickXPositive, 0, SampleInputActionBindingType_Value, &inputActions->RotateRight);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_GamepadLeftStickYPositive, 0, SampleInputActionBindingType_Value, &inputActions->RotateUp);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_GamepadLeftStickYNegative, 0, SampleInputActionBindingType_Value, &inputActions->RotateDown);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_GamepadLeftStickButton, 0, SampleInputActionBindingType_Value, &inputActions->TriangleColor);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputID_GamepadLeftTrigger, 0, SampleInputActionBindingType_Value, &inputActions->RotateSideLeft);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputID_GamepadRightTrigger, 0, SampleInputActionBindingType_Value, &inputActions->RotateSideRight);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputID_GamepadLeftShoulder, 0, SampleInputActionBindingType_Value, &inputActions->ZoomOut);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputID_GamepadRightShoulder, 0, SampleInputActionBindingType_Value, &inputActions->ZoomIn);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputID_GamepadButtonA, 0, SampleInputActionBindingType_Value, &inputActions->TriangleColor);

    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_Touch, 0, SampleInputActionBindingType_Value, &inputActions->Touch);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchXNegative, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateLeft);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchXPositive, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateRight);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchYNegative, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateUp);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchYPositive, 0, SampleInputActionBindingType_Value, &inputActions->TouchRotateDown);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchXAbsolutePosition, 0, SampleInputActionBindingType_Value, &inputActions->TouchPositionX);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchYAbsolutePosition, 0, SampleInputActionBindingType_Value, &inputActions->TouchPositionY);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_Touch, 1, SampleInputActionBindingType_Value, &inputActions->Touch2);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchXAbsolutePosition, 1, SampleInputActionBindingType_Value, &inputActions->Touch2PositionX);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_TouchYAbsolutePosition, 1, SampleInputActionBindingType_Value, &inputActions->Touch2PositionY);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_Touch, 0, SampleInputActionBindingType_Released, &inputActions->TouchReleased);
    SampleRegisterInputActionBinding(inputActionBindings, ElemInputId_Touch, 0, SampleInputActionBindingType_DoubleReleasedSwitch, &inputActions->TriangleColor);
}
