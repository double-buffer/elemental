...
static MetalGraphicsService* _globalMetalGraphicsService; 

DllExport void Native_InitGraphicsService(GraphicsServiceOptions* options)
{
    _globalMetalGraphicsService = new MetalGraphicsService(options);
}

DllExport void Native_FreeGraphicsService()
{
    delete _globalMetalGraphicsService;
}
...
DllExport void Native_GetAvailableGraphicsDevices(GraphicsDeviceInfo* graphicsDevices, int* count)
{
    ...
    _globalMetalGraphicsService->GetAvailableGraphicsDevices(graphicsDevices, count);
}
...
DllExport void* Native_CreateGraphicsDevice(GraphicsDeviceOptions* options)
{
    ...
    BaseGraphicsService* graphicsService = (BaseGraphicsService*)_globalMetalGraphicsService;
